# Brewfile
# List of all packages installed by Homebrew
...
brew 'bfg'           # removes large or troublesome blobs like git-filter-branch does, but faster
...
brew 'ffmpeg'
brew 'graphviz'
brew 'ghostscript'   # interpreter for the PostScript language and for PDF
